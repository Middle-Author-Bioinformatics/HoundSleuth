...
python3 /home/ark/MAB/bin/HoundSleuth/send_email.py \
    --sender pseudofinder@midauthorbio.com \
    --recipient ${email} \
    --subject "Your Pseudofinder Results!" \
    --body "Hi ${name},

    Your Pseudofinder results are available for download using the link below. The link will expire in 24 hours.
...
conda deactivate
echo "Pseudofinder completed successfully."
