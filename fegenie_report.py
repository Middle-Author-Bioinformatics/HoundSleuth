...
Generate a self-contained, interactive HTML report from a FeGenie heatmap-format
CSV file. The report contains:
...
<div class="container">
  ...
  <footer>
    Generated by <code>fegenie_report.py</code>. Open this file in any modern browser &mdash; no internet required.
  </footer>
</div>
</body>
</html>
